        ...
        .then(function(applications) {
          ...
          applications.forEach(function(app) {
            ...
            if (app.status === 'pending') {
              html += '<button class="btn btn-sm btn-success me-1" onclick="updateApplicationStatus(' + app.id + ', \'approved\')">Approve</button>';
              html += '<button class="btn btn-sm btn-danger" onclick="updateApplicationStatus(' + app.id + ', \'rejected\')">Reject</button>';
            } else {
